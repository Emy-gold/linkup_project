...
<body class="bg-background-light dark:bg-background-dark  text-slate-800 font-sans dark:text-slate-200  min-h-screen flex flex-col transition-colors duration-300">
