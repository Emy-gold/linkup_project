...
<body class="bg-gradient-to-br from-background-light to-blue-50 text-slate-800 font-sans min-h-screen flex items-center justify-center py-8">
<div class="w-full max-w-2xl">
    ...
    <div class="bg-surface-light rounded-lg shadow-lg p-8 md:p-12">
        ...
        <!-- Formulaire -->
        <form method="POST" action="${pageContext.request.contextPath}/recruteur/complete-profile" class="space-y-6">
