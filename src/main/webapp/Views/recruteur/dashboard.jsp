  ...
  <main class="flex-1 overflow-y-auto px-8 py-8">
    <div class="space-y-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-surface-light border border-slate-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm text-slate-600 font-medium">Annonces Publiées</p>
              <p class="text-3xl font-bold text-slate-900 mt-2"><%--${totalAnnonces != null ? totalAnnonces : 0}--%>5</p>
            </div>
        ...
        <div class="bg-surface-light border border-slate-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-slate-900 mt-2"><%--${totalCandidatures != null ? totalCandidatures : 0}--%>2</p>
            </div>
        ...
        <div class="bg-surface-light border border-slate-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-slate-900 mt-2"><%--${totalCandidats != null ? totalCandidats : 0}--%></p>
            </div>
        ...
        <div class="bg-surface-light border border-slate-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-slate-900 mt-2"><%--${acceptanceRate != null ? acceptanceRate : 0}%--%></p>
            </div>
