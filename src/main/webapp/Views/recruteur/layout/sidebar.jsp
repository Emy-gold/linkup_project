    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <link rel="stylesheet"
                ...
                integrity="sha384-k6RqeWeci5ZR/Lv4MR0sA0FfDOMq8r7sS1s5M5c5L5z5J5Z5g5Z5g5Z5g5Z5g5"
                crossorigin="anonymous">
        </head>

        <!-- Sidebar -->
        <aside
            class="w-56 bg-surface-light border-r border-slate-200 min-h-screen sticky top-0 flex flex-col shadow-lg">
            <!-- Logo -->
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="${pageContext.request.contextPath}/recruteur/entretiens"
                    ...
                    <i class="fas fa-calendar-check w-5 text-xl"></i>
