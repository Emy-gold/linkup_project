...
<%--                <p class="text-slate-500 mt-1">Bienvenue, &lt;%&ndash;<c:out value="${recruteurName}"/>&ndash;%&gt;Founti</p>--%>
<%--            </div>--%>
...
<%--                    <p class="text-2xl font-bold text-slate-800">&lt;%&ndash;<c:out value="${totalOffres}"/>&ndash;%&gt;2</p>--%>
<%--                </div>--%>
<%--            </div>--%>
<%--            <!-- Card 2 -->--%>
<%--            <div class="bg-surface-light rounded-xl shadow-sm border border-slate-100 p-6 flex items-center gap-4">--%>
...
<%--                    <p class="text-2xl font-bold text-slate-800">&lt;%&ndash;<c:out value="${totalCandidats}"/>&ndash;%&gt;3</p>--%>
<%--                </div>--%>
<%--            </div>--%>
<%--            <!-- Card 3 -->--%>
<%--            <div class="bg-surface-light rounded-xl shadow-sm border border-slate-100 p-6 flex items-center gap-4">--%>
...
<%--                    <p class="text-2xl font-bold text-slate-800">&lt;%&ndash;<c:out value="${totalCandidatures}"/>&ndash;%&gt;5</p>--%>
<%--                </div>--%>
<%--            </div>--%>
<%--        </div>--%>
