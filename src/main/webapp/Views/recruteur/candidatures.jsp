<%-- Created by IntelliJ IDEA. User: Pro Date: 2/5/2026 Time: 5:06 PM To change this template use File | Settings | File
    Templates. --%>
            ...
            <body class="bg-background-light text-slate-800 font-sans min-h-screen flex">
                        ...
                        <div class="mb-8 flex gap-4">
                            <form method="get" action="${pageContext.request.contextPath}/recruteur/candidatures">
                                <select name="statut" onchange="this.form.submit()"
                                    ...
                                    <option value="Acceptee" ${param.statut=='Acceptee' ? 'selected' : '' }>
                                        Acceptée
                                    </option>

                                    <option value="Rejetee" ${param.statut=='Rejetee' ? 'selected' : '' }>
                                        Rejetée
                                    </option>
                                </select>
                            </form>
                                                ...
                                                <c:forEach var="cand" items="${candidatures}">
                                                    ...
                                                    <tr class="hover:bg-slate-50 transition-colors" id="row-${cand.id}">
                                                        ...
                                                        <td class="px-6 py-4" id="statut-${cand.id}">
                                                            <c:choose>
                                                                <c:when
                                                                    test="${cand.statutCandidature == 'En_attente' || cand.statutCandidature == 'En attente'}">
                                                                    <span
                                                        ...
                                                        <td class="px-6 py-4">
                                                            <div class="flex items-center gap-2"
                                                                ...
                                                                <!-- Voir CV -->
                                                                <button
                                                                    onclick="openPdfModal('${pageContext.request.contextPath}/${cand.cheminCv}')"
                                                                ...
                                                                <c:if
                                                                    ...
                                                                    <!-- ACCEPTER -->
                                                                    <button
                                                                        onclick="updateStatut(${cand.id}, 'Acceptee')"
                                                                    ...
                                                                    <!-- REJETER -->
                                                                    <button
                                                                        onclick="updateStatut(${cand.id}, 'Rejetee')"
                ...
                <script>
                    ...
                    function showNotification(message, type = 'info') {
                        ...
                        notification.className = `fixed bottom-4 right-4 px-6 py-3 rounded-lg text-white font-semibold z-50 transition-all duration-300 ${type == 'success' ? 'bg-green-600' : type == 'error' ? 'bg-red-600' : 'bg-blue-600'
                            }`;
